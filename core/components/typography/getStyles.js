...
const styles = ({font}) => {
  ...
  const type = StyleSheet.create({
    h1: {
      ...
      // lineHeight: Fonts.fontSize.h1 + 4
    },
    h2: {
      fontSize: Fonts.fontSize.h2,
      // lineHeight: Fonts.fontSize.h2 + 4
    },
    h3: {
      fontSize: Fonts.fontSize.h3,
      // lineHeight: Fonts.fontSize.h3 + 4
    },
    h4: {
      fontSize: Fonts.fontSize.h4,
      //   lineHeight: Fonts.fontSize.h4 + 4,
    },
    title: {
      fontSize: Fonts.fontSize.title,
      // lineHeight: Fonts.fontSize.title + 4
    },
    subTitle: {
      fontSize: Fonts.fontSize.subTitle,
      // lineHeight: Fonts.fontSize.subTitle + 4
    },
    caption: {
      fontSize: Fonts.fontSize.caption,
      // lineHeight: Fonts.fontSize.caption + 4
    },
