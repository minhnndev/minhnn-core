        ...
        return (
            <View style={[styles.body, style]}>
                ...
                <View style={styles.textContainer}>
                    {title ? <Text.Title style={[styles.title, titleStyle]}>{title}</Text.Title> : null}
                    {description ? <Text.Title style={[styles.description, descriptionStyle]}>{description}</Text.Title> : null}
                </View>
                {undoTitle
                    ? (
