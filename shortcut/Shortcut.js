...
import {
 Colors, ValueUtil, Image, Text, ScaleSize
} from '@momo-kits/core';
...
export default class IconText extends Component {
    ...
    render() {
        ...
        const iconSource = ValueUtil.getImageSource(source);
        const defaultIconSource = ValueUtil.getImageSource(defaultIcon);
        ...
        return (
            <TouchableOpacity onPress={this.onPress} activeOpacity={onPress ? 0.5 : 1}>
                <View style={[styles.container, style]}>
                    ...
                    <Text.Title style={[styles.title, mapTextStyle, ValueUtil.extractStyle(titleStyle)]} numberOfLines={3} ellipsizeMode="tail">
                        {title?.trim?.()}
                    </Text.Title>
                </View>
            </TouchableOpacity>
